<template>
  <div class="rd-page">
    <header class="rd-page-head">
      <div>
        <h1>Libretas de direcciones</h1>
        <p>{{ listRes.total.toLocaleString() }} entradas</p>
      </div>
    </header>
    ...
    <el-card class="list-body" shadow="hover">
      ...
      <el-table :data="listRes.list" v-loading="listRes.loading" border>
        ...
        <el-table-column :label="T('Actions')" align="right" class-name="table-actions" width="148" fixed="right">
          <template #default="{row}">
